package me.suff.dojo.grant.menu.grants;
...
public class GrantsMenu extends PaginatedMenu {
    ...
    public Map<Integer, Button> getAllPagesButtons(Player player) {
        ...
        List<Grant> grants = Dojo.getInstance().getProfileRepository().getProfileWithNoAdding(this.target.getUniqueId()).getGrants();
